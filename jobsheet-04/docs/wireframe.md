...
|  Konfirmasi   : [______________]                     |
|                                                      |
|  [ Daftar ]   [ Batal ]                              |
+------------------------------------------------------+

2. User Flow: "Petugas mencari anggota yang tunggakannya sudah lewat jatuh tempo"
[Login Petugas]
      |
      v
[Dashboard Petugas]
      |
      v
[Klik menu "Anggota" di navbar]
      |
      v
[Halaman Daftar Anggota]
      |
      v
[Klik filter "Tunggakan Jatuh Tempo"]
      |
      v
[Sistem tampilkan daftar anggota berstatus terlambat]
      |
      +--> (kosong) --> [Tampilkan pesan "Tidak ada tunggakan jatuh tempo"]
      |
      v
[Petugas pilih salah satu anggota]
      |
      v
[Halaman Detail Anggota: daftar buku dipinjam + tanggal jatuh tempo]
      |
      v
[Petugas catat tindakan / kirim notifikasi]

3. Edge Case Tambahan: Buku sama dipinjamkan ke anggota sama dua kali berturut-turut

Sistem harus mengecek status peminjaman aktif sebelum transaksi baru dibuat.
Kalau ditemukan peminjaman aktif untuk pasangan (buku, anggota) yang sama → tampilkan pesan error, misalnya "Buku ini masih dipinjam oleh anggota ini dan belum dikembalikan."
Transaksi peminjaman baru ditolak, bukan otomatis ditumpuk sebagai dua record terpisah.
+-----------------------------------------------------+
...
|  Buku    : [_______________]                           |
|  Tgl Pinjam : [______________]                         |
|                                                        |
|  +---------------------------------------------------+ |
|  | ! Buku ini masih dipinjam oleh anggota ini dan    | |
|  |   belum dikembalikan. Peminjaman tidak dapat      | |
|  |   diproses.                                       | |
|  +---------------------------------------------------+ |
|                                                        |
|  [ Simpan ]   [ Batal ]                                |
